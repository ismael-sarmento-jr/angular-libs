...
import { AppError } from '@ionic-angular-ext/components/error-handler';
import { Constraint } from '@ionic-angular-ext/components/validation';
import { IonInput, IonItemSliding, Platform } from '@ionic/angular';
  ...
  */
  ...
  progressiveRenderItems(list: any[]): void {
    ...
    this.interval = setInterval(() => {
      ...
      this.loading = false; // setting load to false as soon as the first chunk is embeded
